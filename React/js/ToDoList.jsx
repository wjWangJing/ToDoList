...
var ToDoItem = React.createClass({
    ...
    changeItemState : function(){
        ...
        if(this.props.complete == "true"){
            ReactDOM.findDOMNode(this.refs.checkBox).style.background = "url('./image/true.png') no-repeat center center";
            ReactDOM.findDOMNode(this.refs.taskInner).style.textDecoration = "line-through";
            ReactDOM.findDOMNode(this.refs.taskInner).style.color = "#d9d9d9";
        }else{
            ReactDOM.findDOMNode(this.refs.checkBox).style.background = "none";
            ReactDOM.findDOMNode(this.refs.taskInner).style.textDecoration = "none";
            ReactDOM.findDOMNode(this.refs.taskInner).style.color = "#333333";
        }
    },
    /**
